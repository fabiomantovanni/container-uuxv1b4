...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uuxv1b4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uuxv1b4.containers.anotherwebservice.com/
...
```
git clone git@github.com:fabiomantovanni/container-uuxv1b4.git
cd container-uuxv1b4
```
...
```
docker attach container-uuxv1b4
```
